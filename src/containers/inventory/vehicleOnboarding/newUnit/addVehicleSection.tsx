...
import ByVinNumber from "@/components/icons/ByVinNumber";
import ManualEntry from "@/components/icons/ManualEntry";
import SmartAIEntry from "@/components/icons/SmartAIEntry";
import SimpleDropdown from "@/components/simpleDropdown";
import Image from "next/image";

const options = [
  {
    label: "Manual Vehicle Entry",
    onClick: () => {},
    icon: <ManualEntry />,
  },
  {
...
export default function AddVehicleSection() {
  return (
    <div className="relative flex items-center justify-between rounded-lg p-5 sm:p-6 lg:p-7 border border-muted bg-gray-0 pb-8 @4xl:col-span-2 @7xl:col-span-8 lg:pb-9 dark:bg-gray-100/30">
      <div className="@2xl:max-w-[calc(100%-340px)]">
        <h2 className="rizzui-title-h2 font-bold mb-2 text-2xl sm:mb-3 md:text-3xl">
        ...
        <p className="rizzui-text-p font-normal mb-5 text-sm leading-[1.6] text-gray-700 sm:mb-6 sm:text-base md:mb-8 lg:mb-10">
          Ready to add new vehicle? Choose your preferred menthod and keep your inventory up to date!
        </p>
        <SimpleDropdown buttonText={"Add Vehicle"} options={options} />
      </div>
      <div>
