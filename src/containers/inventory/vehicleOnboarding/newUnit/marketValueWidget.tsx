...
const filterOptions = ["1 M", "2 M", "6 M", "1 Y"];
      ...
      >
        <div className="grid flex-grow grid-cols-1 gap-3">
          <div className="relative max-w-sm">
            ...
            />
            <Button
              className="absolute end-0 top-0 text-sm font-normal hover:text-[#18746c]"
              type="submit"
              variant="text"
            >
              Check
          ...
          />
          <div className="mt-auto h-64 w-full pb-2  @sm:pt-3 @7xl:h-[130px] lg:pb-2">
          ...
          <Text className="text-gray-500 @sm:text-xs  @sm:mt-0 mb-1">
            Estimated based on 31 similar vehicles sold between Mar 21, 2024 -
            Ju 16, 2024
          </Text>
          <div className="border bg-[#FDF6F3] rounded-lg p-4">
            <Title
              className={cn(
            ...
            <Select
              selectClassName="bg-white focus:border-transparent hover:border-transparent"
              variant="text"
              inPortal={false}
              placeholder="182,582"
              options={[
            ...
            <div className="mt-3">
              {data2.map((item, index) => (
                <div
                  key={item.name}
                  className="mb-2 flex items-center justify-between border-b border-muted pb-1 last:mb-0 last:border-0 last:pb-0"
                >
                  <div className="flex items-center justify-start">
                    ...
                    <Text
                      as="span"
                      className="ml-1 text-base font-semi-bold text-xs font-bold text-gray-900 font-lexend"
                    >
                      {item.name}
                    </Text>
                  </div>
